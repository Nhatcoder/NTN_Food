                                    ...
                                    <div class="offcanvas-form">
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="hoten" value="<?= $hoten ?>" required type="text"
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="anh_taikhoan" value="<?= $anh_taikhoan ?>"
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="sodienthoai" value="<?= $sodienthoai ?>" required
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="email" value="<?= $email ?>" required type="text"
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="diachi" value="<?= $diachi ?>" required type="text"
                                        ...
                                        <div class="form-group m-b30">
                                            ...
                                            <div class="input-group search-input">
                                                <input name="pass" value="<?= $matkhau ?>" type="password"
