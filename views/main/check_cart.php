    ...
    <div class="dz-bnr-inr style-1 text-center bg-parallax"
        ...
        <div class="container">
            <div class="dz-bnr-inr-entry">
                <h1>Thanh toán cửa hàng</h1>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Trang chủ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Thanh toán cửa hàng</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
                ...
                <div class="row">
                        ...
                        <div class="widget">
                            ...
                            <button class="btn btn-gray btnhover mb-3" type="button" data-bs-toggle="collapse"
                                data-bs-target="#create-an-account">Create an account <i
                                    class="fa fa-angle-down m-l10"></i></button>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div id="different-address" class="collapse">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 m-b20">
                                    <input name="dzOther[Other]" type="text" class="form-control"
                                        placeholder="Apartment, suite, unit etc.">
                                </div>
                                <div class="form-group col-md-6 m-b20">
                                    <input name="dzOther[Town/City]" type="text" class="form-control"
                                        placeholder="Town / City">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 m-b20">
                                    <input name="dzOther[State/County]" type="text" class="form-control"
                                        placeholder="State / County">
                                </div>
                                <div class="form-group col-md-6 m-b20">
                                    <input name="dzOther[Postcode/Zip]" type="text" class="form-control"
                                        placeholder="Postcode / Zip">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 m-b20">
                                    <input name="dzPhoneNumber" type="text" class="form-control dz-number"
                                        placeholder="Phone">
                                </div>
                            </div>
                            <p>Create an account by entering the information below. If you are a returning customer
            ...
            <div class="row">
                    ...
                    <div class="widget">
                        ...
                        <table class="table-bordered check-tbl">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="product-item-img"><img src="assets/images/gallery/small/pic4.jpg"
                                            alt="/"></td>
                                    <td class="product-item-name">Prduct Item 4</td>
                                    <td class="product-price">$36.00</td>
                                </tr>
                                <tr>
                                    <td class="product-item-img"><img src="assets/images/gallery/small/pic3.jpg"
                                            alt="/"></td>
                                    <td class="product-item-name">Prduct Item 3</td>
                                    <td class="product-price">$25.00</td>
                                </tr>
                                <tr>
                                    <td class="product-item-img"><img src="assets/images/gallery/small/pic2.jpg"
                                            alt="/"></td>
                                    <td class="product-item-name">Prduct Item 2</td>
                                    <td class="product-price">$22.00</td>
                                </tr>
                                <tr>
                                    <td class="product-item-img"><img src="assets/images/gallery/small/pic1.jpg"
                                            alt="/"></td>
                ...
                <div class="col-lg-6">
                    <form class="shop-form widget">
                        ...
                        <div class="form-group">
                            <button class="btn btn-gray btn-hover-2" type="submit" value="submit" name="submit">Place
                                Order Now </button>
                        </div>
                    </form>
                </div>
