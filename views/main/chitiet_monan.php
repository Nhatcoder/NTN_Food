						...
						<div class="detail-info">
							...
							<div class="d-lg-flex justify-content-between">
								<ul class="modal-btn-group">
									<li><a href="shop-cart.php" class="btn btn-primary btn-hover-1"><span>Add To Cart <i class="flaticon-shopping-bag-1 m-l10"></i></span></a></li>
									<li><a href="shop-checkout.php" class="btn btn-outline-secondary btn-hover-1"><span>Buy Now <i class="flaticon-shopping-cart m-l10"></i></a></span></li>
								</ul>
								<ul class="avatar-list avatar-list-stacked">
									<li class="avatar"><img src="views/assets/images/testimonial/small/pic1.jpg" alt=""></li>
									<li class="avatar"><img src="views/assets/images/testimonial/small/pic2.jpg" alt=""></li>
									<li class="avatar"><img src="views/assets/images/testimonial/small/pic3.jpg" alt=""></li>
									<li class="avatar"><img src="views/assets/images/testimonial/small/pic4.jpg" alt=""></li>
									<li class="avatar"><img src="views/assets/images/testimonial/small/pic5.jpg" alt=""></li>
								...
								<div class="comments-area" id="comments">
									<ul class="comment-list">
										<li class="comment">
											<div class="comment-body">
												<div class="comment-author vcard"> 
													<img  class="avatar photo" src="views/assets/images/testimonial/mini/pic1.jpg" alt="/"> 
										...
										<li class="comment">
											<div class="comment-body">
												<div class="comment-author vcard"> 
													<img  class="avatar photo" src="views/assets/images/testimonial/mini/pic2.jpg" alt="/"> 
										...
										<li class="comment">
											<div class="comment-body">
												<div class="comment-author vcard"> 
													<img  class="avatar photo" src="views/assets/images/testimonial/mini/pic3.jpg" alt="/"> 
						...
						<div class="swiper-wrapper p-b5">
							<div class="swiper-slide">
								<div class="dz-img-box style-2">
									...
									<div class="dz-content">
										<h4 class="dz-title"><a href="product-detail.php">Pizza</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipiscing.</p>
										<h5 class="dz-price text-primary">$55.00</h5>
										<a href="shop-cart.php" class="btn btn-primary btn-hover-2"> Add To Cart</a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="dz-img-box style-2">
									...
									<div class="dz-content">
										<h4 class="dz-title"><a href="product-detail.php">Rice</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipiscing.</p>
							...
							<div class="swiper-slide">
								<div class="dz-img-box style-2">
									...
									<div class="dz-content">
										<h4 class="dz-title"><a href="product-detail.php">Green Salad</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipiscing.</p>
							...
							<div class="swiper-slide">
								<div class="dz-img-box style-2">
									...
									<div class="dz-content">
										<h4 class="dz-title"><a href="product-detail.php">Pasta</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipiscing.</p>
