						...
						<ul id="masonry" class="row">
							<li class="card-container col-xl-4 col-md-6 m-b30">
								<div class="dz-img-box style-7">
									<div class="dz-media">
										<img src="views/assets/images/gallery/grid4/pic1.jpg" alt="/">
										<div class="dz-meta">
											<ul>
							...
							<li class="card-container col-xl-4 col-md-6 m-b30">
								<div class="dz-img-box style-7">
									<div class="dz-media">
										<img src="views/assets/images/gallery/grid4/pic2.jpg" alt="/">
										<div class="dz-meta">
											<ul>
												<li class="seller">Top Seller</li>
							...
							<li class="card-container col-xl-4 col-md-6 m-b30">
								<div class="dz-img-box style-7">
									<div class="dz-media">
										<img src="views/assets/images/gallery/grid4/pic3.jpg" alt="/">
										<div class="dz-meta">
											<ul>
												<li class="seller">Top Seller</li>
							...
							<li class="card-container col-xl-4 col-md-6 m-b30">
								<div class="dz-img-box style-7">
									<div class="dz-media">
										<img src="views/assets/images/gallery/grid4/pic4.jpg" alt="/">
										<div class="dz-meta">
											<ul>
												<li class="seller">Top Seller</li>
							...
							<li class="card-container col-xl-4 col-md-6 m-b30">
								<div class="dz-img-box style-7">
									<div class="dz-media">
										<img src="views/assets/images/gallery/grid4/pic5.jpg" alt="/">
										<div class="dz-meta">
											<ul>
												<li class="seller">Top Seller</li>
							...
							<li class="card-container col-xl-4 col-md-6 m-b30">
								<div class="dz-img-box style-7">
									<div class="dz-media">
										<img src="views/assets/images/gallery/grid4/pic6.jpg" alt="/">
										<div class="dz-meta">
											<ul>
												<li class="seller">Top Seller</li>
												<li class="rating"><i class="fa-solid fa-star"></i> 4.0</li>
