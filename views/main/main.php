	...
	<div class="offcanvas-body">
		...
		<div class="offcanvas-form">
			<div class="login-head">
				...
				<p>Chúng tôi rất mong bạn tham gia mạng lưới người sáng tạo và người làm việc tự do 100% từ xa của chúng
					tôi..</p>
			...
			<div class="form-group m-b30">
				...
				<div class="input-group search-input">
					<input name="password" type="password" class="form-control dz-password" placeholder="Nhập mật khẩu">
					<div class="show-pass">
			...
			<p class="text-center m-t30">Chưa có tài khoản?
				<a class="register text-primary font-weight-500" data-bs-toggle="offcanvas" href="#offcanvasRegister"
					role="button" aria-controls="offcanvasRegister">Đăng ký ở đây</a>
			</p>
		</div>
	</div>
</div>
	...
	<div class="offcanvas-body">
		...
		<div class="offcanvas-form">
			...
			<div class="form-group m-b15">
				...
				<div class="input-group">
					<input name="dzName" required type="text" class="form-control" placeholder="Nhập họ và tên">
				</div>
			</div>
			<div class="form-group m-b15">
				<label class="form-label">Số điện thoại*</label>
				<div class="input-group">
					<input name="dzEmail" required type="text" class="form-control" placeholder="Nhập số điện thoại">
				</div>
			</div>
			<div class="form-group m-b30">
				<label class="form-label">Mật khẩu*</label>
			...
			<p class="text-center m-t30">Bạn đã có tài khoản?
				<a class="text-primary font-weight-500" data-bs-toggle="offcanvas" href="#offcanvasLogin" role="button"
					aria-controls="offcanvasLogin">Đăng nhập</a>
			</p>
		</div>
	</div>
</div>
