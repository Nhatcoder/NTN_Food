...
{
    $sql = "SELECT a.ma_donhang, c.hoten,c.diachi,c.sodienthoai, a.id_trangthai,a.ngaymua,d.tentrangthai  FROM tbl_giohang a  INNER join tbl_taikhoan c ON a.id_nguoidung = c.id_nguoidung INNER JOIN tbl_trangthai d on a.id_trangthai = d.id_trangthai WHERE a.id_trangthai IN (4);";
    $listdhtk = pdo_query($sql);
    return $listdhtk;
}
function loaddonhanghuy()
{
    $sql = "SELECT a.ma_donhang, c.hoten,c.diachi,c.sodienthoai, a.id_trangthai,a.ngaymua,d.tentrangthai  FROM tbl_giohang a  INNER join tbl_taikhoan c ON a.id_nguoidung = c.id_nguoidung INNER JOIN tbl_trangthai d on a.id_trangthai = d.id_trangthai WHERE a.id_trangthai IN (5);";
