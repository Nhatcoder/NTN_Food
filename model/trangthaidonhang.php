...
{
    $sql = "SELECT a.loai_thanhtoan,a.ma_donhang, c.hoten,c.diachi,c.sodienthoai, a.id_trangthai,a.ngaymua,d.tentrangthai  FROM tbl_hoadon a  INNER join tbl_diachinhanhang c ON a.id_nguoidung = c.id_nguoidung INNER JOIN tbl_trangthai d on a.id_trangthai = d.id_trangthai WHERE a.id_trangthai IN (0,1, 2, 3);";
    $listdh = pdo_query($sql);
    return $listdh;
}
function loaddonhangtk()
{
    $sql = "SELECT a.loai_thanhtoan,a.ma_donhang, c.hoten,c.diachi,c.sodienthoai, a.id_trangthai,a.ngaymua,d.tentrangthai  FROM tbl_hoadon a  INNER join tbl_diachinhanhang c ON a.id_nguoidung = c.id_nguoidung INNER JOIN tbl_trangthai d on a.id_trangthai = d.id_trangthai WHERE a.id_trangthai IN (4);";
