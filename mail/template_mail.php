...
$sql = "SELECT code_cart FROM tbl_cart where id_cart = '$id_kh'";
$st = $conn->prepare($sql);
$st->execute();
                                                ...
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                    ...
                                                    <div class="space-y-4">
                                                        <h1 class="text-4xl fw-800"
                                                            ...
                                                            align="left">Cảm ơn bạn đã mua đặt hàng của chúng tôi</h1>
                                                        ...
                                                        <p class=""
                                                            ...
                                                            align="left">Thời gian giao hàng ước tính từ lúc mua hàng
                                                            đến lúc trả hàng là ok.
                                                        </p>
                                                        <table class="s-4 w-full" role="presentation" border="0"
                                                            cellpadding="0" cellspacing="0" style="width: 100%;"
                                                            width="100%">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 192px; margin: 0;"
                                                                        ...
                                                                        <a href="nhattop1.click"
                                                                            style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #dc3545; padding: 8px 24px; border: 1px solid #dc3545;">Theo
                                                                            dõi đơn hàng</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-right"
                                                                                    ...
                                                                                    align="right" width="100%">$10.00
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;"
                                                                                    align="left" width="100%">Trucker
                                                                                    Hat</td>
                                                                                <td class="text-right"
                                                                                    style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;"
                                                                                    align="right" width="100%">$12.00
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;"
                                                                                    align="left" width="100%">Sunflower
                                                                                    Seeds</td>
                                                                                <td class="text-right"
                                                                                    style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;"
                                                                                    align="right" width="100%">$20.00
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="fw-700 border-top"
                                                                                    ...
                                                                                    align="left" width="100%">Số tiền
                                                                                    phải trả</td>
                                                                                <td class="fw-700 text-right border-top"
                                                                                    style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;"
                                                                                    align="right" width="100%">$42.00
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">Nếu bạn có bất kỳ câu hỏi nào, hãy
                                                                        liên hệ với chúng tôi qua mail <a href="#"
                                                                            style="color: #0d6efd;">nhatl2bhlc@gmail.com<span
                                                                                class="__cf_email__"
                                                                                data-cfemail="b8f0d1c8fbd7cac8f8ddc0d9d5c8d4dd96dbd7d5"></span></a>
                                                                        xin cảm ơn!
                                                                    </p>
                                                                </td>
                                                            </tr>
